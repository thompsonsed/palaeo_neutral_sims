...
if __name__ == "__main__":
    ...
    global_save_dir = os.path.join(homedir, "Results/PaleoMain/Clustered1")
    ...
    sample_file, fine_file, fragment_file = get_sim_type(
        interval, tetrapod_group, data_dir, fragment_dir,
    )
    ...
    if is_pause_sim:
        ...
        simulation.resume_coalescence(
            pause_directory=output_dir, seed=seed, job_type=job_type, max_time=60 * 60 * 71, out_directory=output_dir
        )
    else:
        simulation.run()
