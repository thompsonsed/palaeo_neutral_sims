...
if __name__ == "__main__":
	...
	save_dir = os.path.join(homedir, "Results/PaleoMain/Sim7")
	...
	end_location = os.path.join(save_dir, "data_{}_{}.db".format(job_type, seed))
	...
	try:
		...
		simtree.set_speciation_parameters(speciation_rates=speciation_rates, record_spatial=True,
		                                  record_fragments=True, sample_file=sample_file)
		simtree.apply()
	except IOError:
		pass
		...
		try:
			...
			try:
				shutil.copy2(speciation_file,
							 os.path.join(homedir, "Results/Dump/",
