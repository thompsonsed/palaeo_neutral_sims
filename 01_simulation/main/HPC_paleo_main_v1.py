...
def get_sim_parameters(job_num):
	"""
	...
	for interval in intervals:
		for tetra_group in tetrapod_groups:
			...
			for seed in range(25):
				sim_list.append([interval, tetra_group, seed, job_type])
...
if __name__ == "__main__":
	...
	save_dir = "/work/set114/Panama/Results/PaleoMain/Sim3/"
	...
	params = get_sim_parameters(pbs_index)
	seed = params["seed"]
	...
	fragment_dir = "/work/set114/Panama/Configs/"
	...
	simulation.set_simulation_params(seed=seed, job_type=job_type, output_directory=output_dir,
									 min_speciation_rate=10**-9, sigma=sigma, tau=0.0, deme=density_per_km,
	...
	end_location = os.path.join(save_dir, "SQL_data", "data_{}_{}.db".format(str(job_type), str(seed)))
	...
	paused_files_list = ["Dump_active_{}_{}.csv", "Dump_data_{}_{}.csv", "Dump_main_{}_{}.csv", "Dump_map_{}_{}.csv"]
	is_pause_sim = True
	...
	speciation_file = simulation.output_directory + "/SQL_data/data_{}_{}.db".format(job_type, seed)
	try:
		...
		simtree.set_speciation_params("T", fragment_file, speciation_rates)
		...
		try:
			...
			try:
				shutil.copy2(speciation_file,
							 os.path.join("/work/set114/Panama/Results/Dump/",
